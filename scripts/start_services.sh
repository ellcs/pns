...
# WORLD
docker exec -it mantel_world2_1 /bin/bash -c "service nginx start"  

# CLIENT

# BACKEND
docker exec -it mantel_server2_1 /bin/bash -c "service postgresql start" 
docker exec -it mantel_server3_1 /bin/bash -c "service cups start"

# SERVER
docker exec -it mantel_server1_1 /bin/bash -c "service nginx start"  
docker exec -it mantel_server2_1 /bin/bash -c "service squid start && service dovecot start" 
docker exec -it mantel_server3_1 /bin/bash -c "service postfix start" 
